...
const joseph = {
  ...
  currentlyLearning: ["React", "Node.js", "PostgreSQL"],
  askMeAbout: ["Web Dev", "Tech", "Problem Solving"],
  funFact: "I break things just to fix them better",
  goals: ["Build cool stuff", "Keep learning", "Help others code"]
};
```
...
### **Languages**
<img src="https://skillicons.dev/icons?i=js,java,python,cpp&theme=dark" />
...
<p align="center">
  <i>⭐️ Thanks for stopping by! Let's build something amazing together.</i>
</p>
...
- 💬 Ask me about: **JavaScript, Problem solving, Tech**
